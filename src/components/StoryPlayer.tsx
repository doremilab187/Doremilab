  ...
  useEffect(() => {
    try {
      ...
      Object.keys(videoUrls).forEach(k => {
        ...
        if (url && !url.startsWith('blob:') && !url.includes('audiovisual') && !url.includes('sound-logo.mp4')) {
